...
namespace Mills_4800.Controllers
{
    public class PlanesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "planeID,planeName,planeTime")] Plane plane)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "planeID,planeName,planeTime")] Plane plane)
        {
            if (ModelState.IsValid)
            {
